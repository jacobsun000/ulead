      ...
      <div className="flex flex-row mt-8 md:mt-12">
        ...
        <div className="absolute left-[60%] transform -translate-x-1/2 -translate-y-1/4 z-10">
          <Image
            ...
            width={96}
            height={96}
            className="rounded-full shadow-md object-contain bg-white"
          />
        </div>
      </div>
        ...
        <div className="w-2/5">
          ...
          >
            <Image
              ...
              alt={name}
              fill
              className="object-contain rounded-bl-2xl"
              sizes="(min-width:1024px) 40vw, 100vw"
              priority
            />
          </div>
          <div className="text-black/80 text-center">{offers?.[0]}</div>
        </div>
      </div>
