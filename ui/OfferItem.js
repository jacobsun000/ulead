  ...
  return (
    <div className="bg-white flex w-full items-center justify-between p-4 rounded-full shadow-md">
      ...
      <div className="flex items-center">
        <div className="w-8 h-8 md:w-16 md:h-16 rounded-full overflow-hidden mr-4 md:mr-16">
      ...
      {/* Count and arrow */}
      <div className="flex items-center">
        <span className="text-gray-700 font-bold mr-4 md:ml-4 md:mr-8 md:text-xl">{count}</span>
